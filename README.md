...
<img alt="GOOSE Logo" src="https://github.com/leostudiooo/GOOSE/raw/main/img/GOOSE.webp" width=128 />
...
1. **配置用户信息**
- 填写 Token（需要在小程序或网页中获取，获取方法见 [ml-seu-exercise-helper](https://github.com/leostudiooo/ml-seu-exercise-helper)）
  - 建议填写后**立刻进行一次验证**
- 设置锻炼时间
- 选择运动场地
- 上传开始和结束图片
